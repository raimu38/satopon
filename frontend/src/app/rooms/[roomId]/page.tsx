            ...
            <span className="relative flex items-center justify-center gap-2">
              ...
              Approve
                                                       ...
                                                       {pendingReq && (
                                                         ...
                                                         <span className="text-white font-bold text-lg">
                                                         {(userMap[pendingReq.from_uid]?.display_name.charAt(0).toUpperCase()) || pendingReq.from_uid.charAt(0).toUpperCase()}
                                                         </span>
                                                         </div>
                                                         <div>
                                                         <p className="text-white font-semibold">
                                                         {userMap[pendingReq.from_uid]?.display_name || pendingReq.from_uid}
                                                         </p>
